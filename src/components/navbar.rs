    ...
    html! {
        <nav class="navbar bg-base-100 w-full py-4 bg-transparent sticky top-0 z-[50]">
            <div class="navbar-start pl-8">
                <a href="/domex/" class="btn btn-ghost text-2xl text-base-content">{"DOMEX"}</a>
            </div>
                    ...
                    // Dropdown menu for mobile
                    {
                        if *menu_visible {
                            ...
                            <ul tabindex="0" class="menu dropdown-content z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                                <li><a href="/domex/" class="text-xl font-bold text-base-content">{"Strona Główna"}</a></li>
                                <li><a href="/domex/products" class="text-xl font-bold text-base-content">{"Produkty"}</a></li>
                                <li><a href="/domex/installations" class="text-xl font-bold text-base-content">{"Realizacja"}</a></li>
                                <li><a href="/domex/about-us" class="text-xl font-bold text-base-content">{"O Nas"}</a></li>
                                <li><a href="/domex/contact" class="text-xl font-bold text-base-content">{"Kontakt"}</a></li>
                            </ul>
                            }
                        } else {
                            html! {}
